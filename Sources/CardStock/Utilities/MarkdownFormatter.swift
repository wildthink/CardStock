...
let log = Logger(subsystem: "markdown", category: "styling")

struct MarkdownStyle {
    init() {}
    func attributes(for kind: PresentationIntent.Kind) -> AttributeContainer {
        AttributeContainer()
    }
}
...
final class MarkdownFormatter {
    private var style: MarkdownStyle = .init()
    ...
    private func presentationIntentAttributes(
        ...
        style.attributes(for: presentationKind)
